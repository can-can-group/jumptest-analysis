...
METRIC_EXPLANATIONS: Dict[str, str] = {
    ...
    "jump_height_impulse_m": "Jump height from impulse-momentum method: v²/(2g), v = impulse/mass (m).",
    "takeoff_velocity_m_s": "Vertical take-off velocity from impulse/mass (m/s).",
